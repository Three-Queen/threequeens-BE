...
<form method="POST" action="{{ route('admin.produk.store') }}" enctype="multipart/form-data">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6" x-data="produkForm({{ $kategori->toJson() }}, {{ $nextIndex }})">
                ...
                <div class="mb-4">
                    ...
                    <div class="grid grid-cols-3 gap-2 mb-2">
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" name="panjang" value="{{ old('panjang') }}"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" name="lebar" value="{{ old('lebar') }}"
                                    placeholder="0" min="0" step="0.1"
                                    class="w-full pl-3 pr-10 py-2.5 border-2 rounded-xl text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 focus:outline-none focus:border-primary transition-colors border-gray-200">
                                <span class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 text-xs font-medium pointer-events-none">cm</span>
                            </div>
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" name="ketebalan" value="{{ old('ketebalan') }}"
                                    placeholder="0" min="0" step="0.1"
                                    class="w-full pl-3 pr-10 py-2.5 border-2 rounded-xl text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 focus:outline-none focus:border-primary transition-colors border-gray-200">
        ...
        <div class="space-y-5">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5"
                 x-data="{ tab3d: '{{ old('desain_produk_3d_embed') ? 'embed' : 'file' }}', embedUrl: '{{ old('desain_produk_3d_embed') }}', get cleanUrl() { return window.parseEmbedInput ? window.parseEmbedInput(this.embedUrl) : ''; }, get isValid() { return !!this.cleanUrl; } }">
                ...
                <div x-show="tab3d === 'file'" x-transition>
                    <x-file-dropzone
                        ...
                        label=""
                        accept=".glb,.gltf"
                        hint="Format GLB atau GLTF (max 200MB)"
                        :is-image="false"
                        color="purple"
                    />
                </div>
